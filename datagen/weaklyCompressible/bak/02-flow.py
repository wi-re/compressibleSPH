...
parser.add_argument('--plotWidth', type=int, default=20, help='Width of the plot in inches')
...
parser.add_argument('--W', type=float, default=2.0, help='Width of the domain')
