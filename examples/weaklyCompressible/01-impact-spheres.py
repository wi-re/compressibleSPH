#!/usr/bin/env python
"""01 impact spheres -- thin wrapper around the shared runner.

The notebook this came from is `01-impact_spheres.ipynb`; the case itself is
...
plotting, ffmpeg) is `warpSPH.runner`. Equivalent invocations::
    ...
    python examples/weaklyCompressible/01-impact-spheres.py --shape circle --nx 256
...
PRESET = ['--plot', '--shape', 'circle', '--nx', '256']
