...
def dilateSurfaceMaskWarp(
    ...
    with record_function("warpSPH[dilateSurfaceMask]"):
        with record_function("warpSPH[dilateSurfaceMask] - Preprocessing"):
        ...
        #         launch_kernel, dilateSurfaceMask_Kernel, outputSize, outputDtype,
        #         *args,
