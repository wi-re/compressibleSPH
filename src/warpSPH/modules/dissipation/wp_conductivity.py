...
def computeConductivity_Func_i(
    ...
    for neighborIndex in range(numIndices):
        ...
        out += - scalar_t(0.5)*apparentVolume * pi * (u_j - u_i) * laplacian_ij
...
def computeConductivity_Func_Adjacency(
    ...
    u_i = access_optional(queryEnergies, i, explicitPressure, scalar_t(0.0))
    ...
    for o in range(numOffsets):
        ...
        out += computeConductivity_Func_i(
            i, dim, 
            xi, hi, mi, rhoi,
...
@wp.kernel
def computeConductivity_Kernel(
    queryState: Any,
    referenceState: Any,
    domainState: domainData,
    ...
    outputValues[i] = computeConductivity_Func_Adjacency(
        i, domainState.dim, 
...
def computeConductivityWarp(
    ...
    with record_function("warpSPH[computeConductivity]"):
        with record_function("warpSPH[computeConductivity] - Preprocessing"):
        ...
        #         launch_kernel, computeConductivity_Kernel, outputSize, outputDtype,
        #         *args,
        #         queryVelocities_, referenceVelocities_,
        #         queryEnergies_, referenceEnergies_,
        #         individual_cs, queryCs_, referenceCs_,
    ...
    return conductivityParams.thermalConductivity * warp_result
