...
def countNeighborsWarp(
    ...
    with record_function("warpSPH[countNeighbors]"):
        with record_function("warpSPH[countNeighbors] - Preprocessing"):
        ...
        #         launch_kernel, countNeighbors_Kernel, outputSize, outputDtype,
        #         *args,
