...
class BoundaryOperatorTerms(Enum):
    ...
    the published CFL (`cflFactor=0.1`): `staticBoundary` cuts `mean|rho-1|`
    ...
    - **It is a published-CFL result.** At the shipped `cflFactor=0.3` (3x
      [BK]'s limit) it diverges at t=1.41 where `full` reaches t=5.54 -- a
