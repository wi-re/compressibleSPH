...
def sampleInitialWaveState(nx, config: SimulationConfig, caseConfig: CaseConfig):
...
def computeDt(waveSystem: WaveSystemv3, config: SimulationConfig, caseConfig: CaseConfig, args, obstacleSpeeds: List[float], verbose=False):
